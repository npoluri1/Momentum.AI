...
const comparisons = [
  { feature: 'AI App Builder', momentum: 'Genesis with workspace DNA', lovable: 'Prompt-to-React app', },
  { feature: 'No-Code Option', momentum: true, lovable: true, },
  { feature: 'Team Workspaces', momentum: 'Multi-player, real-time', lovable: 'Limited collaboration', },
  { feature: 'AI Agents', momentum: 'Autonomous task agents', lovable: 'No dedicated agents', },
  { feature: 'Workflow Automations', momentum: 'Visual automation engine', lovable: 'Not available', },
  { feature: 'CRM & Project Tools', momentum: 'Built-in CRM, Kanban', lovable: 'Not available', },
  { feature: 'Client Portals', momentum: 'Branded portals with auth', lovable: 'Not available', },
  { feature: 'Live Dashboards', momentum: 'Real-time KPI dashboards', lovable: 'Not available', },
  { feature: 'Data Persistence', momentum: 'Projects store living data', lovable: 'Static exports', },
  { feature: 'Integrations', momentum: '100+ native integrations', lovable: 'Few integrations', },
  { feature: 'White-Label', momentum: 'Full white-label support', lovable: 'Limited', },
  { feature: 'Pricing', momentum: 'Free tier + $16/mo Pro', lovable: 'Free tier + $20/mo', },
];
        ...
        <section className="py-20 md:py-28 relative overflow-hidden opacity-0 animate-fade-in-up">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
              ...
              <span className="momentum-text">Lovable alternative</span>
            </h1>
            <p className="text-lg md:text-xl text-surface-500 dark:text-surface-400 max-w-2xl mx-auto mb-8">
              Momentum AI goes beyond app generation — it gives you a complete workspace with agents, automations, and team tools.
            </p>
        ...
        <section className="py-16 md:py-20 opacity-0 animate-fade-in-up delay-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-surface-500 dark:text-surface-400">Why teams are switching from Lovable to Momentum AI.</p>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-white/[0.08] bg-surface-50 dark:bg-white/[0.03]">
                    ...
                    <th scope="col" className="text-center px-5 py-4 font-medium text-surface-500">Lovable</th>
                  </tr>
                </thead>
                    ...
                    <tr key={row.feature} className="hover:bg-surface-50 dark:hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        {typeof row.lovable === 'boolean' ? (
                          row.lovable ? <CheckCircle className="w-4 h-4 text-memory-500 mx-auto" /> : <XCircle className="w-4 h-4 text-surface-300 mx-auto" />
                        ) : (
                          <span className="text-xs text-surface-500">{row.lovable}</span>
                        )}
                      </td>
                    </tr>
                  ))}
        ...
        <section className="py-16 md:py-20 bg-surface-50/50 dark:bg-white/[0.02] opacity-0 animate-fade-in-up delay-300">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { icon: Bot, title: 'Agents That Work For You', desc: 'Momentum AI deploys autonomous agents. Lovable generates UI but has no agent layer.' },
                { icon: Workflow, title: 'Automations Built-In', desc: 'Connect your app to Slack, email, CRM, and more with visual workflows.' },
                { icon: Globe, title: 'Client Portals & Dashboards', desc: 'Publish branded portals with auth and payments. Beyond static web apps.' },
                { icon: Users, title: 'True Team Collaboration', desc: 'Multiplayer editing, comments, and shared workspaces built for teams.' },
              ].map((item) => {
