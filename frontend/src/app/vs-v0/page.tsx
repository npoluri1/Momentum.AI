...
const comparisons = [
  { feature: 'AI App Builder', momentum: 'Genesis — full workspace', v0: 'UI component generator', },
  { feature: 'No-Code Option', momentum: true, v0: false, },
  { feature: 'Team Workspaces', momentum: 'Multi-player, real-time', v0: 'Individual projects', },
  { feature: 'AI Agents', momentum: 'Autonomous task agents', v0: 'No agents', },
  { feature: 'Workflow Automations', momentum: 'Visual automation engine', v0: 'Not available', },
  { feature: 'CRM & Project Tools', momentum: 'Built-in CRM, Kanban', v0: 'Not available', },
  { feature: 'Client Portals', momentum: 'Branded portals with auth', v0: 'Not available', },
  { feature: 'Live Dashboards', momentum: 'Real-time KPI dashboards', v0: 'Not available', },
  { feature: 'Data Persistence', momentum: 'Projects store living data', v0: 'Static components', },
  { feature: 'Integrations', momentum: '100+ native integrations', v0: 'Vercel ecosystem', },
  { feature: 'White-Label', momentum: 'Full white-label support', v0: 'Not available', },
  { feature: 'Pricing', momentum: 'Free tier + $16/mo Pro', v0: 'Free + $20/mo', },
];
        ...
        <section className="py-20 md:py-28 relative overflow-hidden opacity-0 animate-fade-in-up">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
              ...
              <span className="momentum-text">V0 alternative</span>
            </h1>
            <p className="text-lg md:text-xl text-surface-500 dark:text-surface-400 max-w-2xl mx-auto mb-8">
              Momentum AI builds complete living systems — not just UI components. Agents, automations, and team workspaces included.
            </p>
        ...
        <section className="py-16 md:py-20 opacity-0 animate-fade-in-up delay-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-surface-500 dark:text-surface-400">Why teams are switching from V0 to Momentum AI.</p>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-white/[0.08] bg-surface-50 dark:bg-white/[0.03]">
                    ...
                    <th scope="col" className="text-center px-5 py-4 font-medium text-surface-500">V0</th>
                  </tr>
                </thead>
                    ...
                    <tr key={row.feature} className="hover:bg-surface-50 dark:hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        {typeof row.v0 === 'boolean' ? (
                          row.v0 ? <CheckCircle className="w-4 h-4 text-memory-500 mx-auto" /> : <XCircle className="w-4 h-4 text-surface-300 mx-auto" />
                        ) : (
                          <span className="text-xs text-surface-500">{row.v0}</span>
                        )}
                      </td>
                    </tr>
                  ))}
        ...
        <section className="py-16 md:py-20 bg-surface-50/50 dark:bg-white/[0.02] opacity-0 animate-fade-in-up delay-300">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { icon: Bot, title: 'Beyond UI Components', desc: 'V0 generates React components. Momentum AI generates full apps with databases, auth, and automations.' },
                { icon: Workflow, title: 'Automations Built-In', desc: 'Visual workflow engine with 100+ integrations. V0 has no automation layer.' },
                { icon: Globe, title: 'Client Portals & Dashboards', desc: 'Publish branded portals with Stripe and auth. Not just component previews.' },
                { icon: Users, title: 'True Team Collaboration', desc: 'Real-time multiplayer editing built for teams. V0 is solo-first.' },
              ].map((item) => {
