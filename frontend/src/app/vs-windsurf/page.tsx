...
const comparisons = [
  { feature: 'AI App Builder', momentum: 'Genesis with workspace DNA', windsurf: 'Code editor AI', },
  { feature: 'No-Code Option', momentum: true, windsurf: false, },
  { feature: 'Team Workspaces', momentum: 'Multi-player, real-time', windsurf: 'Limited sharing', },
  { feature: 'AI Agents', momentum: 'Autonomous task agents', windsurf: 'Copilot-style', },
  { feature: 'Workflow Automations', momentum: 'Visual automation engine', windsurf: 'Not available', },
  { feature: 'CRM & Project Tools', momentum: 'Built-in CRM, Kanban', windsurf: 'Not available', },
  { feature: 'Client Portals', momentum: 'Branded portals with auth', windsurf: 'Not available', },
  { feature: 'Live Dashboards', momentum: 'Real-time KPI dashboards', windsurf: 'Not available', },
  { feature: 'Data Persistence', momentum: 'Projects store living data', windsurf: 'File-based only', },
  { feature: 'Integrations', momentum: '100+ native integrations', windsurf: 'Extensions', },
  { feature: 'White-Label', momentum: 'Full white-label support', windsurf: 'Not available', },
  { feature: 'Pricing', momentum: 'Free tier + $16/mo Pro', windsurf: '$15/mo Pro', },
];
        ...
        <section className="py-20 md:py-28 relative overflow-hidden opacity-0 animate-fade-in-up">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
              ...
              <span className="momentum-text">Windsurf alternative</span>
            </h1>
            <p className="text-lg md:text-xl text-surface-500 dark:text-surface-400 max-w-2xl mx-auto mb-8">
              Momentum AI is the all-in-one AI workspace — not just a code editor with AI assistance.
            </p>
        ...
        <section className="py-16 md:py-20 opacity-0 animate-fade-in-up delay-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-surface-500 dark:text-surface-400">Why teams are switching from Windsurf to Momentum AI.</p>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-white/[0.08] bg-surface-50 dark:bg-white/[0.03]">
                    ...
                    <th scope="col" className="text-center px-5 py-4 font-medium text-surface-500">Windsurf</th>
                  </tr>
                </thead>
                    ...
                    <tr key={row.feature} className="hover:bg-surface-50 dark:hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        {typeof row.windsurf === 'boolean' ? (
                          row.windsurf ? <CheckCircle className="w-4 h-4 text-memory-500 mx-auto" /> : <XCircle className="w-4 h-4 text-surface-300 mx-auto" />
                        ) : (
                          <span className="text-xs text-surface-500">{row.windsurf}</span>
                        )}
                      </td>
                    </tr>
                  ))}
        ...
        <section className="py-16 md:py-20 bg-surface-50/50 dark:bg-white/[0.02] opacity-0 animate-fade-in-up delay-300">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { icon: Bot, title: 'AI Agents, Not Just Copilot', desc: 'Momentum AI deploys autonomous agents that execute tasks end-to-end. Windsurf is a code editor with inline suggestions.' },
                { icon: Workflow, title: 'Automations Built-In', desc: 'Build visual workflows that trigger on events. Windsurf has no automation layer.' },
                { icon: Globe, title: 'Client Portals & Dashboards', desc: 'Publish branded portals with Stripe checkout and auth. Not just a dev environment.' },
                { icon: Users, title: 'True Team Collaboration', desc: 'Real-time multiplayer editing, comments, and presence. Windsurf sharing is limited.' },
              ].map((item) => {
