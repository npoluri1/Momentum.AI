...
const comparisons = [
  { feature: 'AI App Builder', momentum: 'Genesis — full workspace', bolt: 'StackBlitz preview', },
  { feature: 'No-Code Option', momentum: true, bolt: false, },
  { feature: 'Team Workspaces', momentum: 'Multi-player, real-time', bolt: 'Single user focus', },
  { feature: 'AI Agents', momentum: 'Autonomous task agents', bolt: 'Prompt-to-code only', },
  { feature: 'Workflow Automations', momentum: 'Visual automation engine', bolt: 'Not available', },
  { feature: 'CRM & Project Tools', momentum: 'Built-in CRM, Kanban', bolt: 'Not available', },
  { feature: 'Client Portals', momentum: 'Branded portals with auth', bolt: 'Not available', },
  { feature: 'Live Dashboards', momentum: 'Real-time KPI dashboards', bolt: 'Not available', },
  { feature: 'Data Persistence', momentum: 'Projects store living data', bolt: 'Session-based', },
  { feature: 'Integrations', momentum: '100+ native integrations', bolt: 'Limited', },
  { feature: 'White-Label', momentum: 'Full white-label support', bolt: 'Not available', },
  { feature: 'Pricing', momentum: 'Free tier + $16/mo Pro', bolt: 'Free tier + $20/mo', },
];
        ...
        <section className="py-20 md:py-28 relative overflow-hidden opacity-0 animate-fade-in-up">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
              ...
              <span className="momentum-text">Bolt alternative</span>
            </h1>
            <p className="text-lg md:text-xl text-surface-500 dark:text-surface-400 max-w-2xl mx-auto mb-8">
              Momentum AI builds full living systems — not just prototypes in a preview window.
            </p>
        ...
        <section className="py-16 md:py-20 opacity-0 animate-fade-in-up delay-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-surface-500 dark:text-surface-400">Why teams are switching from Bolt to Momentum AI.</p>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-surface-200 dark:border-white/[0.08] bg-surface-50 dark:bg-white/[0.03]">
                    ...
                    <th scope="col" className="text-center px-5 py-4 font-medium text-surface-500">Bolt</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-surface-100 dark:divide-white/[0.04]">
                  {comparisons.map((row) => (
                    <tr key={row.feature} className="hover:bg-surface-50 dark:hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        {typeof row.bolt === 'boolean' ? (
                          row.bolt ? <CheckCircle className="w-4 h-4 text-memory-500 mx-auto" /> : <XCircle className="w-4 h-4 text-surface-300 mx-auto" />
                        ) : (
                          <span className="text-xs text-surface-500">{row.bolt}</span>
                        )}
                      </td>
                    </tr>
                  ))}
        ...
        <section className="py-16 md:py-20 bg-surface-50/50 dark:bg-white/[0.02] opacity-0 animate-fade-in-up delay-300">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { icon: Bot, title: 'From Prototype to Product', desc: 'Bolt generates previews. Momentum AI deploys production apps with databases, auth, and automations.' },
                { icon: Workflow, title: 'Automations Built-In', desc: 'Visual workflow engine that connects your app to Slack, email, CRM, and 100+ tools.' },
                { icon: Globe, title: 'Client Portals & Dashboards', desc: 'Publish branded portals with Stripe checkout and user auth. Not just code demos.' },
                { icon: Users, title: 'Built for Teams', desc: 'Real-time collaboration, role-based access, and shared workspaces. Bolt is solo-first.' },
              ].map((item) => {
